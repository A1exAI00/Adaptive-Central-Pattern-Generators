...
Модель обучается на частоту и амплитуду внешнего сигнала
...
Модель обучается на частоту и амплитуду внешнего сигнала, а так же на фазовые 
